...
const DoctorDashboard = () => {
  ...
  const recentActivities = [
    {
      ...
      detail: "Ahmed Hassan - Hypertension follow-up",
      time: "15 minutes ago",
    },
    {
      icon: "💊",
      ...
      detail: "Fatima Ali - Antibiotics course",
      time: "30 minutes ago",
    },
    {
      icon: "🔬",
      ...
      detail: "Mohammed Ibrahim - Complete Blood Count",
      time: "1 hour ago",
    },
    {
      icon: "✅",
      ...
      detail: "Sara Bekele - All results normal",
      time: "2 hours ago",
    },
  ];
  ...
  const getStatusBadge = (status) => {
    const badges = {
      ...
      scheduled: "bg-indigo-500/20 border-indigo-500/50 text-indigo-300",
        ...
        >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h1 className="text-3xl font-bold text-white mb-2">
                  Welcome back, Dr. {user?.full_name || "Doctor"}! 👨‍⚕️
                </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="lg:col-span-2 backdrop-blur-xl bg-white/5 rounded-2xl border border-indigo-500/20 shadow-2xl overflow-hidden"
            >
                ...
                <div className="space-y-4">
                  {todayPatients.map((patient, index) => (
                    <motion.div
                      ...
                      className="p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 border border-transparent hover:border-indigo-500/30 cursor-pointer group"
                    >
                      <div className="flex items-start gap-4">
                        <div className="flex-shrink-0">
                          <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-lg flex flex-col items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                            <span className="text-white text-xs font-semibold">
                              {patient.time.split(" ")[0]}
                            </span>
                            <span className="text-white/70 text-xs">
                              {patient.time.split(" ")[1]}
                            </span>
                          </div>
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-indigo-300/50 text-xs">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              {patient.status.replace("-", " ").charAt(0).toUpperCase() +
                                patient.status.replace("-", " ").slice(1)}
                            </span>
                        ...
                        <button
                          onClick={() => navigate(`/consultation?patient=${patient.patientId}`)}
                          className="px-4 py-2 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 hover:from-indigo-500/30 hover:to-purple-500/30 border border-indigo-500/30 hover:border-indigo-400/50 text-indigo-300 hover:text-indigo-200 text-sm font-medium rounded-lg transition-all duration-300"
                        >
                          View
                        </button>
                      </div>
                  ...
                  {recentActivities.map((activity, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-indigo-300/70 text-xs mb-1">
                          {activity.detail}
                        </p>
